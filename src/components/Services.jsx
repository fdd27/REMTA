...
const Services = () => {
    ...
    return (
        <div id="services" className="w-full h-screen">
            <h1 className="pt-40 text-[#56423E] text-center text-[2.8125rem] font-semibold leading-[3rem] tracking-wider">Как работи всичко</h1>
            <p className={`w-[77.875rem] mx-auto mt-7 font-medium text-[#56423E] text-justify text-[1.375rem] leading-8 tracking-wide ${raleway.className}`}>
            ...
            {/* Carousel Buttons*/}
            <div className="flex justify-center items-center mt-[4.34rem]">
                {/* Left arrow */}
                <div>
            ...
            <div className="mt-10 mx-auto p-20 flex justify-center items-center w-[69.25rem] h-[23.2065rem] rounded-[1.25rem] bg-[rgba(255,255,255,0.6)] shadow-[7px_7px_0_rgba(0,0,0,0.25)]">
                <div className="flex flex-shrink-0 justify-center items-center w-[16.51963rem] h-[13.30994rem] rounded-[6.25rem_0] border-2 border-solid border-[#FF6E41] bg-white shadow-[4px_4px_0_rgba(0,0,0,0.3)]">
                    <Image src={slides[currentIndex].img} alt="" width='7.5rem' height='7.5rem' />
                </div>
